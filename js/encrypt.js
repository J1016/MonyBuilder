...
var i = function(e, t) {
  ...
  , r = function(e, t) {
	...
	if (null == t)
		return e;
	for (var n = [], r = t.length, o = 0, u = e.length; o < u; o++)
		n[o] = i(e[o], t[o % r]);
	return n
}
  , o = function(e, t) {
  ...
  , u = function(e, t) {
	if (null == e || null == t || e.length != t.length)
		return e;
	for (var n = [], i = e.length, r = 0, u = i; r < u; r++)
		n[r] = o(e[r], t[r]);
	return n
}
  ...
  , M = function(e, t) {
	if (null == e)
		return null;
	for (var n = __toByte(t), i = [], r = e.length, u = 0; u < r; u++)
		i.push(o(e[u], n));
	return i
}
  , D = function(e, t) {
	if (null == e)
		return null;
	for (var n = __toByte(t), r = [], o = e.length, u = 0; u < o; u++)
		r.push(i(e[u], n));
	return r
}
  , M = function(e, t) {
...
var result = y2("c2775284c26a424b8c308a26a84226be", 165 / 286 * 100 + "");
var result2 = F(result);
console.log(result);
console.log(result2);

...
r = function(e, t) {
    ...
    if (null == t) return e;
    for (var n = [], r = t.length, o = 0, u = e.length; o < u; o++) n[o] = i(e[o], t[o % r]);
    return n
},
o = function(e, t) {
    return e = __toByte(e),
...
u = function(e, t) {
    ...
    for (var n = [], i = e.length, r = 0, u = i; r < u; r++) n[r] = o(e[r], t[r]);
    return n
},
...
a = function(e) {
    ...
    for (var t = new String(e), n = [], i = t.length / 2, r = 0, o = 0; o < i; o++) {
        var u = parseInt(t.charAt(r++), 16) << 4,
...
M = function(e, t) {
    if (null == e) return null;
    for (var n = __toByte(t), i = [], r = e.length, u = 0; u < r; u++) i.push(o(e[u], n));
    return i
},
D = function(e, t) {
    if (null == e) return null;
    for (var n = __toByte(t), r = [], o = e.length, u = 0; u < o; u++) r.push(i(e[u], n));
    return r
},
M = function(e, t) {
    if (null == e) return null;
...
function enc(e, t) {
    ...
    i = {
        ...
        raf: function o(e) {
            var o = window.requestAnimationFrame || window.webkitRequestAnimationFrame ||
            function(e) {
        ...
        uuid: function u(e, t) {
            ...
            u = [],
            i = void 0;
            if (t = t || n.length, e) for (i = 0; i < e; i++) u[i] = n[0 | Math.random() * t];
            else {
                var r = void 0;
                for (u[8] = u[13] = u[18] = u[23] = "-", u[14] = "4", i = 0; i < 36; i++) u[i] || (r = 0 | 16 * Math.random(), u[i] = n[19 === i ? 3 & r | 8 : r])
            }
            return u.join("")
        }
    };
